...
export default function RotatingABadge() {
  return (
    <div className="relative w-[360px] h-[360px] mb-[140px]">
      {/* Glow detrás */}
      <div className="absolute inset-0 -z-10 bg-gradient-to-br from-primary/40 via-primary/10 to-transparent rounded-3xl blur-3xl" />
      ...
      {/* A */}
      <div className=" left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 relative z-30 w-64 h-64 bg-gradient-to-br from-primary/10 to-accent/5 rounded-2xl border border-accent/20 flex items-center justify-center backdrop-blur-xlg">
